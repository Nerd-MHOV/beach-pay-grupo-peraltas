...
const Panel = () => {
  return (
    <div className="px-2 sm:px-10 py-3 relative grid grid-cols gap-5">
      ...
      <div className="bg-background p-7 rounded-xl shadow-lg space-y-4">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">R$ 231.89</div>
              <p className="text-xs text-muted-foreground">+19% desse mês</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
          ...
          <Card className="col-span-3">
            <CardHeader>
              ...
              <CardDescription>
                Você teve 232 investimentos esse mês.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <RecentSales />
