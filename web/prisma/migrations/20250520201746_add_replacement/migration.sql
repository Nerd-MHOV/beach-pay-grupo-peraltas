...
-- AddForeignKey
ALTER TABLE "lesson_attendance" ADD CONSTRAINT "lesson_attendance_replacement_id_fkey" FOREIGN KEY ("replacement_id") REFERENCES "lesson"("id") ON DELETE SET NULL ON UPDATE CASCADE;
